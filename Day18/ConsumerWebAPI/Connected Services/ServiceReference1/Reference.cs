...
namespace ServiceReference1
{
    ...
    public interface IAuthorService
    {
        ...
        System.Threading.Tasks.Task<int> MySoapMethodAsync(int num1, int num2);
    }
    ...
    public partial class AuthorServiceClient : System.ServiceModel.ClientBase<ServiceReference1.IAuthorService>, ServiceReference1.IAuthorService
    {
        ...
        public System.Threading.Tasks.Task<int> MySoapMethodAsync(int num1, int num2)
        {
            return base.Channel.MySoapMethodAsync(num1, num2);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IAuthorService))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:7151/Service.asmx");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
